...
//     let filteredData=products.filter(p=>p.category==="walk")
//     console.log(filteredData);
//     filteredData=!q?[...filteredData]:filteredData.filter(p=>p.name.indexOf(q)>-1&&p.category==="walk")
...
return <ProductListPublic category="Walk"></ProductListPublic>
}
